...
public final class ResourceAttributeEntryImpl extends AbstractAttributeMapEntry<ResourceAttribute> implements ResourceAttributeEntry {
    ...
    /**
     * Use
     * {@link ResourceAttributeEntryImpl#ResourceAttributeEntryImpl(ResourceAttribute, IterableAttributeMap)}
     * instead.
     * 
     * @param attribute
     * @param primaryAttributeEntry
     * @deprecated since 0.0.13
     */
    @Deprecated(since = "0.0.13", forRemoval = true)
    @ForRemoval(since = "0.0.13", expectedRemovalVersion = "0.0.15")
    ResourceAttributeEntryImpl(ResourceAttribute attribute, AttributeMapEntry<PrimaryAttribute> primaryAttributeEntry) {
        super(attribute);
    ...
    */
    @Deprecated
    ResourceAttributeEntryImpl(ResourceAttribute attribute, AttributeMapEntry<PrimaryAttribute> primaryAttributeEntry, Level level) {
